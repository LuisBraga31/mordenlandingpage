        ...
        <section className="bg-white py-16">
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                                ...
                                <div className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3' key={index}>
                                    <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col'>
                                        ...
                                        <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                            ...
                                            <a href="#" className='flex items-center justify-center gap-2 hover:bg-red-500 py-1 px-4 rounded-md duration-300'>
                    ...
                    <button
                        className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute left-2 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 cursor-pointer'
                        onClick={scrollPrev}>
