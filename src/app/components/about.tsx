            ...
            <div className="container px-4 mx-auto"> 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 mt-9">
                        ...
                        <p>
                            Until one has loved an animal, a part of one's soul remains unawakened. We believe in it and 
                        ...
                        <div className="flex  gap-2">
                            <a href={`https://wa.me/556799990000?text=Olá vim pelo site e gostaria de mais informações`} className="bg-[#E84C3D] text-white flex items-center justify-center w-fit gap-2 px-4 py-2 rounded-md">
